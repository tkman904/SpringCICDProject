        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="product__pagination blog__pagination">
                	<a style="cursor: pointer;" v-if="store.startPage>1" @click="store.prev(store.startPage-1)">
                		<i class="fa fa-long-arrow-left"></i>
                	</a>
                    <a style="cursor: pointer;" v-for="i in store.range(store.startPage, store.endPage)" @click="store.pageChange(i)">{{i}}</a>
                    <a style="cursor: pointer;" v-if="store.endPage<store.totalpage" @click="store.next(store.endPage+1)">
